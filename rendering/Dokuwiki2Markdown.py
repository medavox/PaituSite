...
When you use the ''%%<code>%%'' or ''%%<file>%%'' syntax as above, you might want to make th...
...
#(r"\[\[(https?://[\w./?&=+,#-]+)\]\]",	r"<\1>"),			#links without labeltext OLD
...
(r"<file ([\w.#+-]+) ([^>]+)>\n?((.|\n)+?)\n?</file>", unembedFile),	#convert embedded <file> blocks into included separate files
